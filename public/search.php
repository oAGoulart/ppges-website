    ...
    <div class="container">
      ...
      <?php
        if ($pages > 1) {
          ...
          if ($page_number == 1)
            echo '<li class="page-link disabled"><a class="page-link" href="#" tabindex="-1" aria-hidden="true">&laquo;</a></li>';
          else {
          ...
          if ($page_number == $pages)
            echo '<li class="page-link disabled"><a class="page-link" href="#" tabindex="-1" aria-hidden="true">&raquo;</a></li>';
          else {
            $request = change_page_number($base_url, $page_number, $page_number + 1);
